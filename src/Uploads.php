...
class Uploads
{
    ...
    public static function base64FileUpload($userId, $encoded_string, $folder)
    {
        $upload_dir = self::upload_folder($folder);
        ...
        try {
            FS::createDirectories($upload_dir);
            FS::filePutContent(JK_SITE_PATH() . $file_dir, $decoded_file);
